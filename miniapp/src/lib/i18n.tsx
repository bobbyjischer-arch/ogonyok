...
const ru = {
  ...
  howItWorksHint: 'Таймер считает от последнего чистого старта. Серии — по отметкам каждый день, с честным учётом расписания.',
  now: 'сейчас',
  weeklyProgress: 'Недельный прогресс',
  weeklyProgressHint: 'Процент выполнения запланированных дней за последние 8 недель',
  historyGrid: 'Последние дни',
...
const en: Record<Key, string> = {
  ...
  howItWorksHint: 'Timer counts from your last clean start. Streaks are built day by day, respecting your schedule.',
  now: 'now',
  weeklyProgress: 'Weekly progress',
  weeklyProgressHint: 'Completion rate of scheduled days over the last 8 weeks',
  historyGrid: 'Recent days',
